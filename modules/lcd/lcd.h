...
// Jeffrey070318增加：从学长工程移植LCD驱动，当前工程main.h未生成RES/BLK引脚名时在这里给出兼容定义。
#ifndef LCD_RES_Pin
#define LCD_RES_Pin GPIO_PIN_11
#define LCD_RES_GPIO_Port GPIOB
#endif

// Jeffrey070318增加：LCD背光默认沿用学长工程PB10，避免修改CubeMX生成的main.h。
#ifndef LCD_BLK_Pin
...
// Jeffrey070318修改：背光宏改成无参形式，匹配lcd.c里的LCD_BLK_Set()/LCD_BLK_Clr()调用。
