...
// void StartDELTATASK(void const *argument);
...
// __attribute__((noreturn)) void StartDELTATASK(void const *argument)
// {
//     static float angle = 0.0f;
//     LOGINFO("[freeRTOS] Delta Task Start");
    
//     DeltaInit();
//     LOGINFO("[freeRTOS] Delta Init Done, communication with ref has established");
//     for (;;)
//     {
//         osDelay(2000);
//         DeltaTask(angle);
